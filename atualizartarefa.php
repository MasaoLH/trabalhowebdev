    ...
    if(!empty($_GET['id'])){
        ...
        if($result -> num_rows > 0)
        {
            while($user_data = mysqli_fetch_assoc($result)){
                $name = $user_data['nometarefa'];
                $descricao = $user_data['descricaotarefa'];
            }
        }
        else{
...
<body>
    ...
    <div class="box">
        <form method="POST" action="salvaruptarefa.php">
            <fieldset>
                <legend align='center'><b>Atualizando Tarefa</b></legend>
                <br>
                <div class="inputBox">
